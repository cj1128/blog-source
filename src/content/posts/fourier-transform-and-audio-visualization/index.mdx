...
createdDate: 2021-07-26T15:12:57+08:00
...
import hz200 from './200hz.wav'

<audio controls>
  <source src={hz200} type="audio/wav" />
</audio>

这是 800hz 的声音，可以明显感觉到，声音更加尖锐了。

import hz800 from './800hz.wav'

<audio controls>
  <source src={hz800} type="audio/wav" />
</audio>
...
import mixed from './mixed.wav'

<audio controls>
  <source src={mixed} type="audio/wav" />
</audio>
...
<Tip>不得不说科学计算还是 Python 方便，numpy 和 scipy 真的太好用了。</Tip>
...
[demo]: http://cjdev.me/audio-vis-demo/
